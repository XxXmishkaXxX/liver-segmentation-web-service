...
from .views import UploadImagesView, BatchPredictionView, DeleteBatchView, GetBatchImagesView, UpdateMaskImage
...
urlpatterns = [
    ...
    path('update_mask/<int:mask_id>/', UpdateMaskImage.as_view(), name='update_mask')
